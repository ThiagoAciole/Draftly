...
describe('markdown processor', () => {
	describe('path resolver', () => {
		it('resolves relative paths correctly', () => {
			expect(resolvePath('C:/notes/main.md', './images/photo.png')).toBe('C:/notes/images/photo.png');
			expect(resolvePath('C:/notes/main.md', '../avatar.jpg')).toBe('C:/avatar.jpg');
			expect(resolvePath('/home/user/notes/main.md', 'images/photo.png')).toBe('/home/user/notes/images/photo.png');
		});

		it('leaves absolute paths intact', () => {
			expect(resolvePath('C:/notes/main.md', 'D:/photos/photo.png')).toBe('D:/photos/photo.png');
			expect(resolvePath('/home/user/notes/main.md', '/var/log/app.log')).toBe('/var/log/app.log');
		});
	});
	...
	describe('html processing', () => {
		it('processes blockquote callouts/alerts', () => {
			const rawHtml = '<blockquote><p>[!NOTE]<br>This is a note alert.</p></blockquote>';
		...
		it('processes task checkboxes', () => {
			const rawHtml = '<ul><li class="task-list-item"><input type="checkbox"> Task item</li></ul>';
			const processed = processMarkdownHtml(rawHtml, 'note.md', new Set());
