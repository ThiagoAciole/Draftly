...
export function getSupportedLanguages() {
  return [
    ...
    {
      code: "zh-CN" as LanguageCode,
      name: "Chinese (Simplified)",
      nativeName: "简体中文",
    },
    {
      code: "zh-TW" as LanguageCode,
...
export const translations: Record<LanguageCode, Translation> = {
  en: {
    settings: {
      ...
      codeAndJsonFiles: "Code and JSON files",
      textFiles: "Text",
    ...
    toast: {
      ...
      savedNewerEdits:
        "Saved — staying in edit mode because you have newer edits",
    },
    modal: {
      confirmExit: "Confirm Exit",
      areYouSureYouWantToExit:
        "Are you sure you want to exit? All unsaved tabs and local history will be lost.",
      unsavedChanges: "Unsaved Changes",
      youHaveUnsavedChanges:
        'You have unsaved changes in "{title}". Do you want to save them before closing?',
      youHaveUnsavedChangesBeforeReturning:
        "You have unsaved changes. Do you want to save them before returning to view mode?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "You have unsaved changes. Do you want to save them before closing split view?",
      youHaveUnsavedFiles:
        "You have {{count}} unsaved file(s). Do you want to save your changes?",
    },
    recovery: {
    ...
    update: {
      ...
      upToDateBody:
        "You're using the latest version of Draftly (v{{version}}).",
      upToDateBodyNoVersion: "You're using the latest version of Draftly.",
      availableHeader: "Update available",
      availableBody:
        "Draftly v{{latest}} is available. You're on v{{current}}.",
      releaseNotes: "Release notes",
      downloadingHeader: "Downloading update…",
      downloadingBody: "Downloading Draftly v{{version}}…",
      downloadingProgress: "{{downloaded}} MB of {{total}} MB ({{pct}}%)",
      downloadingProgressUnknown: "{{downloaded}} MB downloaded",
      downloadingHint:
        "Draftly will restart automatically when the update is ready.",
      ...
      errorInstallBody:
        "The update was downloaded but Draftly could not restart automatically. Please quit and reopen Draftly to finish installing.",
  ...
  "zh-CN": {
    ...
    modal: {
      confirmExit: "确认退出",
      areYouSureYouWantToExit:
        "确定要退出吗？所有未保存的标签和本地历史记录将丢失。",
      unsavedChanges: "未保存的更改",
      youHaveUnsavedChanges: '"{title}"中有未保存的更改。关闭前要保存吗？',
      youHaveUnsavedChangesBeforeReturning:
        "您有未保存的更改。返回查看模式前要保存吗？",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "您有未保存的更改。关闭分屏视图前要保存吗？",
  ...
  ja: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "自動保存に失敗しました — 未保存の変更はメモリ内に残っています",
      savedNewerEdits:
        "保存しました — 新しい編集があるため編集モードを継続します",
    },
    modal: {
      confirmExit: "終了を確認",
      areYouSureYouWantToExit:
        "終了しますか？すべての未保存のタブとローカル履歴が失われます。",
      unsavedChanges: "未保存の変更",
      youHaveUnsavedChanges:
        '"{title}"に未保存の変更があります。閉じる前に保存しますか？',
      youHaveUnsavedChangesBeforeReturning:
        "未保存の変更があります。表示モードに戻る前に保存しますか？",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "未保存の変更があります。分割ビューを閉じる前に保存しますか？",
      youHaveUnsavedFiles:
        "{{count}} つの保存されていないファイルがあります。変更を保存しますか？",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "これにより、アプリケーションとそのすべてのショートカットが削除されます。",
      cancel: "キャンセル",
      uninstall: "アンインストール",
  ...
  "zh-TW": {
    ...
    modal: {
      confirmExit: "確認退出",
      areYouSureYouWantToExit:
        "您確定要退出嗎？所有未保存的標籤和本地歷史將丟失。",
      unsavedChanges: "未保存的更改",
      youHaveUnsavedChanges:
        '您在 "{title}" 中有未保存的更改。您想在關閉前保存嗎？',
      youHaveUnsavedChangesBeforeReturning:
        "您有未保存的更改。您想在返回預覽模式前保存嗎？",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "您有未保存的更改。您想在關閉分割視圖前保存嗎？",
      youHaveUnsavedFiles:
        "您有 {{count}} 個未保存的文件。您想保存您的更改嗎？",
    },
    home: {
  ...
  ko: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "자동 저장 실패 — 저장되지 않은 변경 사항은 메모리에 남아 있습니다",
      savedNewerEdits: "저장됨 — 새로운 편집이 있어 편집 모드를 유지합니다",
    },
    modal: {
      confirmExit: "종료 확인",
      areYouSureYouWantToExit:
        "정말 종료하시겠습니까? 저장되지 않은 모든 탭과 로컬 기록이 손실됩니다.",
      unsavedChanges: "저장되지 않은 변경 사항",
      youHaveUnsavedChanges:
        '"{title}"에 저장되지 않은 변경 사항이 있습니다. 닫기 전에 저장하시겠습니까?',
      youHaveUnsavedChangesBeforeReturning:
        "저장되지 않은 변경 사항이 있습니다. 보기 모드로 돌아가기 전에 저장하시겠습니까?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "저장되지 않은 변경 사항이 있습니다. 분할 보기를 닫기 전에 저장하시겠습니까?",
      youHaveUnsavedFiles:
        "저장되지 않은 {{count}}개 파일이 있습니다. 변경 사항을 저장하시겠습니까?",
    },
    home: {
  ...
  ru: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Автосохранение не удалось — несохранённые правки остались только в памяти",
      savedNewerEdits:
        "Сохранено — остаюсь в режиме редактирования, так как есть более новые правки",
    },
    modal: {
      confirmExit: "Подтвердить выход",
      areYouSureYouWantToExit:
        "Вы уверены, что хотите выйти? Все несохранённые вкладки и локальная история будут потеряны.",
      unsavedChanges: "Несохранённые изменения",
      youHaveUnsavedChanges:
        'У вас есть несохранённые изменения в "{title}". Вы хотите сохранить их перед закрытием?',
      youHaveUnsavedChangesBeforeReturning:
        "У вас есть несохранённые изменения. Вы хотите сохранить их перед возвратом в режим просмотра?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "У вас есть несохранённые изменения. Вы хотите сохранить их перед закрытием разделённого вида?",
      youHaveUnsavedFiles:
        "У вас есть {{count}} несохранённых файлов. Вы хотите сохранить изменения?",
    },
    home: {
  ...
  es: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Error de autoguardado — los cambios no guardados siguen en memoria",
      savedNewerEdits:
        "Guardado — se mantiene el modo de edición porque hay cambios más recientes",
    },
    modal: {
      confirmExit: "Confirmar salida",
      areYouSureYouWantToExit:
        "¿Está seguro de que desea salir? Se perderán todas las pestañas sin guardar y el historial local.",
      unsavedChanges: "Cambios sin guardar",
      youHaveUnsavedChanges:
        'Tiene cambios sin guardar en "{title}". ¿Desea guardarlos antes de cerrar?',
      youHaveUnsavedChangesBeforeReturning:
        "Tiene cambios sin guardar. ¿Desea guardarlos antes de volver al modo de vista?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Tiene cambios sin guardar. ¿Desea guardarlos antes de cerrar la vista dividida?",
      youHaveUnsavedFiles:
        "Tiene {{count}} archivo(s) sin guardar. ¿Desea guardar los cambios?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Se eliminará la aplicación y todos sus accesos directos.",
      cancel: "Cancelar",
  ...
  fr: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Échec de l'enregistrement automatique — les modifications non enregistrées restent en mémoire",
      savedNewerEdits:
        "Enregistré — maintien du mode édition car des modifications plus récentes existent",
    },
    modal: {
      confirmExit: "Confirmer la sortie",
      areYouSureYouWantToExit:
        "Êtes-vous sûr de vouloir quitter ? Tous les onglets non enregistrés et l'historique local seront perdus.",
      unsavedChanges: "Modifications non enregistrées",
      youHaveUnsavedChanges:
        'Vous avez des modifications non enregistrées dans "{title}". Voulez-vous les enregistrer avant de fermer ?',
      youHaveUnsavedChangesBeforeReturning:
        "Vous avez des modifications non enregistrées. Voulez-vous les enregistrer avant de revenir en mode aperçu ?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Vous avez des modifications non enregistrées. Voulez-vous les enregistrer avant de fermer la vue divisée ?",
      youHaveUnsavedFiles:
        "Vous avez {{count}} fichier(s) non enregistré(s). Voulez-vous enregistrer vos modifications ?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "L'application et tous ses raccourcis seront supprimés.",
      cancel: "Annuler",
  ...
  de: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatisches Speichern fehlgeschlagen — nicht gespeicherte Änderungen bleiben im Speicher",
      savedNewerEdits:
        "Gespeichert — Bearbeitungsmodus bleibt aktiv, da neuere Änderungen vorliegen",
    },
    modal: {
      confirmExit: "Beenden bestätigen",
      areYouSureYouWantToExit:
        "Sind Sie sicher, dass Sie beenden möchten? Alle ungespeicherten Tabs und der lokale Verlauf gehen verloren.",
      unsavedChanges: "Ungespeicherte Änderungen",
      youHaveUnsavedChanges:
        'Sie haben ungespeicherte Änderungen in "{title}". Möchten Sie diese vor dem Schließen speichern?',
      youHaveUnsavedChangesBeforeReturning:
        "Sie haben ungespeicherte Änderungen. Möchten Sie diese vor der Rückkehr zum Vorschau-Modus speichern?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Sie haben ungespeicherte Änderungen. Möchten Sie diese vor dem Schließen der geteilten Ansicht speichern?",
      youHaveUnsavedFiles:
        "Sie haben {{count}} ungespeicherte Datei(en). Möchten Sie Ihre Änderungen speichern?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Die Anwendung und alle ihre Verknüpfungen werden entfernt.",
      cancel: "Abbrechen",
  ...
  "pt-BR": {
    settings: {
      ...
      markdownFiles: "Arquivos Markdown",
      codeAndJsonFiles: "Código e JSON",
      textFiles: "Texto",
      ...
      markdownToolbar: "Barra de ferramentas",
      ...
      discard: "Descartar",
      themeDefault: "Padrão",
      themeDefaultLight: "Claro",
      themeDefaultDark: "Escuro",
      themeFollowSystem: "Seguir sistema",
      colors: {
        default: "Padrão",
        yellow: "Amarelo",
    ...
    toast: {
      ...
      autoSaveFailed:
        "Falha ao salvar automaticamente — alterações não salvas ainda estão na memória",
      savedNewerEdits:
        "Salvo — mantendo o modo de edição porque há edições mais recentes",
    },
    modal: {
      confirmExit: "Confirmar saída",
      areYouSureYouWantToExit:
        "Tem certeza de que deseja sair? Todas as abas não salvas e o histórico local serão perdidos.",
      unsavedChanges: "Alterações não salvas",
      youHaveUnsavedChanges:
        'Você tem alterações não salvas em "{title}". Deseja salvá-las antes de fechar?',
      youHaveUnsavedChangesBeforeReturning:
        "Você tem alterações não salvas. Deseja salvá-las antes de retornar ao modo de visualização?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Você tem alterações não salvas. Deseja salvá-las antes de fechar a visualização dividida?",
      youHaveUnsavedFiles:
        "Você tem {{count}} arquivo(s) não salvo(s). Deseja salvar suas alterações?",
    },
    recovery: {
      title: "Recuperar documentos",
      description:
        "O Draftly encontrou edições que talvez não tenham sido salvas no disco.",
    ...
    uninstaller: {
      ...
      removeApplication:
        "O aplicativo e todos os seus atalhos serão removidos.",
      cancel: "Cancelar",
      uninstall: "Desinstalar",
  ...
  it: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Salvataggio automatico non riuscito — le modifiche non salvate sono ancora in memoria",
      savedNewerEdits:
        "Salvato — mantengo la modalità modifica perché ci sono modifiche più recenti",
    },
    modal: {
      confirmExit: "Conferma uscita",
      areYouSureYouWantToExit:
        "Sei sicuro di voler uscire? Tutte le schede non salvate e la cronologia locale andranno perse.",
      unsavedChanges: "Modifiche non salvate",
      youHaveUnsavedChanges:
        'Hai modifiche non salvate in "{title}". Vuoi salvarle prima di chiudere?',
      youHaveUnsavedChangesBeforeReturning:
        "Hai modifiche non salvate. Vuoi salvarle prima di tornare alla modalità anteprima?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Hai modifiche non salvate. Vuoi salvarle prima di chiudere la vista divisa?",
      youHaveUnsavedFiles:
        "Hai {{count}} file non salvati. Vuoi salvare le modifiche?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "L'applicazione e tutti i suoi collegamenti verranno rimossi.",
      cancel: "Annulla",
  ...
  pl: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Autozapis nie powiódł się — niezapisane zmiany pozostają w pamięci",
      savedNewerEdits:
        "Zapisano — pozostaję w trybie edycji, ponieważ są nowsze zmiany",
    },
    modal: {
      confirmExit: "Potwierdź wyjście",
      areYouSureYouWantToExit:
        "Czy na pewno chcesz wyjść? Wszystkie niezapisane karty i historia lokalna zostaną utracone.",
      unsavedChanges: "Niezapisane zmiany",
      youHaveUnsavedChanges:
        'Masz niezapisane zmiany w "{title}". Czy chcesz je zapisać przed zamknięciem?',
      youHaveUnsavedChangesBeforeReturning:
        "Masz niezapisane zmiany. Czy chcesz je zapisać przed powrotem do trybu podglądu?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Masz niezapisane zmiany. Czy chcesz je zapisać przed zamknięciem widoku podzielonego?",
      youHaveUnsavedFiles:
        "Masz {{count}} niezapisanych plików. Czy chcesz zapisać zmiany?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Spowoduje to usunięcie aplikacji i wszystkich jej skrótów.",
      cancel: "Anuluj",
  ...
  nl: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatisch opslaan mislukt — niet-opgeslagen wijzigingen staan nog in het geheugen",
      savedNewerEdits:
        "Opgeslagen — bewerkmodus blijft actief omdat er nieuwere wijzigingen zijn",
    },
    modal: {
      confirmExit: "Bevestig afsluiten",
      areYouSureYouWantToExit:
        "Weet je zeker dat je wilt afsluiten? Alle niet-opgeslagen tabbladen en lokale geschiedenis gaan verloren.",
      unsavedChanges: "Niet-opgeslagen wijzigingen",
      youHaveUnsavedChanges:
        'Je hebt niet-opgeslagen wijzigingen in "{title}". Wil je deze opslaan voordat je sluit?',
      youHaveUnsavedChangesBeforeReturning:
        "Je hebt niet-opgeslagen wijzigingen. Wil je deze opslaan voordat je terugkeert naar voorbeeldmodus?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Je hebt niet-opgeslagen wijzigingen. Wil je deze opslaan voordat je de gesplitste weergave sluit?",
      youHaveUnsavedFiles:
        "Je hebt {{count}} niet-opgeslagen bestand(en). Wil je je wijzigingen opslaan?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Hiermee wordt de applicatie en alle snelkoppelingen verwijderd.",
      cancel: "Annuleren",
  ...
  sv: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatisk sparning misslyckades — osparade ändringar finns kvar i minnet",
      savedNewerEdits:
        "Sparat — stannar i redigeringsläge eftersom det finns nyare ändringar",
    },
    modal: {
      confirmExit: "Bekräfta avslut",
      areYouSureYouWantToExit:
        "Är du säker på att du vill avsluta? Alla osparade flikar och lokal historik kommer att förloras.",
      unsavedChanges: "Osparade ändringar",
      youHaveUnsavedChanges:
        'Du har osparade ändringar i "{title}". Vill du spara dem innan du stänger?',
      youHaveUnsavedChangesBeforeReturning:
        "Du har osparade ändringar. Vill du spara dem innan du återgår till förhandsgranskningsläge?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Du har osparade ändringar. Vill du spara dem innan du stänger delad vy?",
      youHaveUnsavedFiles:
        "Du har {{count}} osparade filer. Vill du spara dina ändringar?",
    },
    home: {
  ...
  vi: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Tự động lưu thất bại — các thay đổi chưa lưu vẫn còn trong bộ nhớ",
      savedNewerEdits:
        "Đã lưu — vẫn ở chế độ chỉnh sửa vì bạn có chỉnh sửa mới hơn",
    },
    modal: {
      confirmExit: "Xác nhận thoát",
      areYouSureYouWantToExit:
        "Bạn có chắc muốn thoát không? Tất cả các tab chưa lưu và lịch sử cục bộ sẽ bị mất.",
      unsavedChanges: "Thay đổi chưa lưu",
      youHaveUnsavedChanges:
        'Bạn có thay đổi chưa lưu trong "{title}". Bạn có muốn lưu trước khi đóng không?',
      youHaveUnsavedChangesBeforeReturning:
        "Bạn có thay đổi chưa lưu. Bạn có muốn lưu trước khi quay lại chế độ xem trước không?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Bạn có thay đổi chưa lưu. Bạn có muốn lưu trước khi đóng chế độ chia đôi không?",
      youHaveUnsavedFiles:
        "Bạn có {{count}} tệp chưa lưu. Bạn có muốn lưu thay đổi không?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Thao tác này sẽ xóa ứng dụng và tất cả lối tắt của nó.",
      cancel: "Hủy",
  ...
  pt: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Falha ao guardar automaticamente — as alterações não guardadas continuam em memória",
      savedNewerEdits:
        "Guardado — a manter o modo de edição porque tem edições mais recentes",
    },
    modal: {
      confirmExit: "Confirmar saída",
      areYouSureYouWantToExit:
        "Tem a certeza de que pretende sair? Todos os separadores não guardados e o histórico local serão perdidos.",
      unsavedChanges: "Alterações não guardadas",
      youHaveUnsavedChanges:
        'Tem alterações não guardadas em "{title}". Pretende guardá-las antes de fechar?',
      youHaveUnsavedChangesBeforeReturning:
        "Tem alterações não guardadas. Pretende guardá-las antes de voltar ao modo de pré-visualização?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Tem alterações não guardadas. Pretende guardá-las antes de fechar a vista dividida?",
      youHaveUnsavedFiles:
        "Tem {{count}} ficheiro(s) não guardado(s). Pretende guardar as suas alterações?",
    },
    recovery: {
      title: "Recuperar documentos",
      description:
        "O Draftly encontrou edições que poderão não ter sido guardadas no disco.",
    ...
    uninstaller: {
      ...
      removeApplication:
        "Isto irá remover a aplicação e todos os seus atalhos.",
      cancel: "Cancelar",
      uninstall: "Desinstalar",
  ...
  ro: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Salvarea automată a eșuat — modificările nesalvate sunt încă în memorie",
      savedNewerEdits:
        "Salvat — rămân în modul de editare deoarece există modificări mai noi",
    },
    modal: {
      confirmExit: "Confirmare ieșire",
      areYouSureYouWantToExit:
        "Sigur doriți să ieșiți? Toate filele nesalvate și istoricul local vor fi pierdute.",
      unsavedChanges: "Modificări nesalvate",
      youHaveUnsavedChanges:
        'Aveți modificări nesalvate în "{title}". Doriți să le salvați înainte de închidere?',
      youHaveUnsavedChangesBeforeReturning:
        "Aveți modificări nesalvate. Doriți să le salvați înainte de a reveni la modul de previzualizare?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Aveți modificări nesalvate. Doriți să le salvați înainte de a închide vizualizarea împărțită?",
      youHaveUnsavedFiles:
        "Aveți {{count}} fișier(e) nesalvate. Doriți să salvați modificările?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Aceasta va elimina aplicația și toate comenzile rapide ale acesteia.",
      cancel: "Anulare",
  ...
  hu: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatikus mentés sikertelen — a nem mentett módosítások még a memóriában vannak",
      savedNewerEdits:
        "Elmentve — a szerkesztési mód marad, mert újabb módosítások vannak",
    },
    modal: {
      confirmExit: "Kilépés megerősítése",
      areYouSureYouWantToExit:
        "Biztosan ki szeretne lépni? Minden nem mentett lap és helyi előzmény elveszik.",
      unsavedChanges: "Nem mentett módosítások",
      youHaveUnsavedChanges:
        'Nem mentett módosításai vannak a(z) "{title}" fájlban. Menteni szeretné bezárás előtt?',
      youHaveUnsavedChangesBeforeReturning:
        "Nem mentett módosításai vannak. Menteni szeretné az előnézeti módba való visszatérés előtt?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Nem mentett módosításai vannak. Menteni szeretné az osztott nézet bezárása előtt?",
      youHaveUnsavedFiles:
        "{{count}} nem mentett fájlja van. Menteni szeretné a módosításokat?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Ez eltávolítja az alkalmazást és minden parancsikonját.",
      cancel: "Mégse",
  ...
  cs: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatické uložení selhalo — neuložené změny zůstávají v paměti",
      savedNewerEdits:
        "Uloženo — zůstávám v režimu úprav, protože máte novější změny",
    },
    modal: {
      confirmExit: "Potvrdit ukončení",
      areYouSureYouWantToExit:
        "Opravdu chcete ukončit? Všechny neuložené karty a místní historie budou ztraceny.",
      unsavedChanges: "Neuložené změny",
      youHaveUnsavedChanges:
        'Máte neuložené změny v "{title}". Chcete je uložit před zavřením?',
      youHaveUnsavedChangesBeforeReturning:
        "Máte neuložené změny. Chcete je uložit před návratem do režimu náhledu?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Máte neuložené změny. Chcete je uložit před zavřením rozděleného zobrazení?",
      youHaveUnsavedFiles:
        "Máte {{count}} neuložených souborů. Chcete uložit změny?",
    },
    home: {
  ...
  sk: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatické ukladanie zlyhalo — neuložené zmeny zostávajú v pamäti",
      savedNewerEdits:
        "Uložené — zostávam v režime úprav, pretože máte novšie zmeny",
    },
    modal: {
      confirmExit: "Potvrdiť ukončenie",
      areYouSureYouWantToExit:
        "Naozaj chcete ukončiť? Všetky neuložené karty a miestna história budú stratené.",
      unsavedChanges: "Neuložené zmeny",
      youHaveUnsavedChanges:
        'Máte neuložené zmeny v "{title}". Chcete ich uložiť pred zatvorením?',
      youHaveUnsavedChangesBeforeReturning:
        "Máte neuložené zmeny. Chcete ich uložiť pred návratom do režimu náhľadu?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Máte neuložené zmeny. Chcete ich uložiť pred zatvorením rozdeleného zobrazenia?",
      youHaveUnsavedFiles:
        "Máte {{count}} neuložených súborov. Chcete uložiť zmeny?",
    },
    home: {
  ...
  el: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Η αυτόματη αποθήκευση απέτυχε — οι μη αποθηκευμένες αλλαγές παραμένουν στη μνήμη",
      savedNewerEdits:
        "Αποθηκεύτηκε — παραμένω σε λειτουργία επεξεργασίας επειδή υπάρχουν νεότερες αλλαγές",
    },
    modal: {
      confirmExit: "Επιβεβαίωση εξόδου",
      areYouSureYouWantToExit:
        "Είστε σίγουροι ότι θέλετε να εξέλθετε; Όλες οι μη αποθηκευμένες καρτέλες και το τοπικό ιστορικό θα χαθούν.",
      unsavedChanges: "Μη αποθηκευμένες αλλαγές",
      youHaveUnsavedChanges:
        'Έχετε μη αποθηκευμένες αλλαγές στο "{title}". Θέλετε να τις αποθηκεύσετε πριν το κλείσιμο;',
      youHaveUnsavedChangesBeforeReturning:
        "Έχετε μη αποθηκευμένες αλλαγές. Θέλετε να τις αποθηκεύσετε πριν την επιστροφή σε λειτουργία προεπισκόπησης;",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Έχετε μη αποθηκευμένες αλλαγές. Θέλετε να τις αποθηκεύσετε πριν το κλείσιμο της διαιρούμενης προβολής;",
      youHaveUnsavedFiles:
        "Έχετε {{count}} μη αποθηκευμένα αρχεία. Θέλετε να αποθηκεύσετε τις αλλαγές σας;",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Αυτό θα καταργήσει την εφαρμογή και όλες τις συντομεύσεις της.",
      cancel: "Ακύρωση",
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automaattinen tallennus epäonnistui — tallentamattomat muutokset ovat yhä muistissa",
      savedNewerEdits:
        "Tallennettu — pysytään muokkaustilassa, koska sinulla on uudempia muutoksia",
    },
    modal: {
      confirmExit: "Vahvista poistuminen",
      areYouSureYouWantToExit:
        "Haluatko varmasti poistua? Kaikki tallentamattomat välilehdet ja paikallinen historia menetetään.",
      unsavedChanges: "Tallentamattomia muutoksia",
      youHaveUnsavedChanges:
        'Tiedostossa "{title}" on tallentamattomia muutoksia. Haluatko tallentaa ne ennen sulkemista?',
      youHaveUnsavedChangesBeforeReturning:
        "Sinulla on tallentamattomia muutoksia. Haluatko tallentaa ne ennen palaamista esikatselutilaan?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Sinulla on tallentamattomia muutoksia. Haluatko tallentaa ne ennen jaetun näkymän sulkemista?",
      youHaveUnsavedFiles:
        "Sinulla on {{count}} tallentamatonta tiedostoa. Haluatko tallentaa muutokset?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Tämä poistaa sovelluksen ja kaikki sen pikakuvakkeet.",
      cancel: "Peruuta",
  ...
  da: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatisk gemning mislykkedes — ikke-gemte ændringer er stadig i hukommelsen",
      savedNewerEdits:
        "Gemt — bliver i redigeringstilstand, fordi du har nyere ændringer",
    },
    modal: {
      confirmExit: "Bekræft afslutning",
      areYouSureYouWantToExit:
        "Er du sikker på, at du vil afslutte? Alle ikke-gemte faner og lokal historik vil gå tabt.",
      unsavedChanges: "Ikke-gemte ændringer",
      youHaveUnsavedChanges:
        'Du har ikke-gemte ændringer i "{title}". Vil du gemme dem før lukning?',
      youHaveUnsavedChangesBeforeReturning:
        "Du har ikke-gemte ændringer. Vil du gemme dem før du vender tilbage til forhåndsvisningstilstand?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Du har ikke-gemte ændringer. Vil du gemme dem før du lukker delt visning?",
      youHaveUnsavedFiles:
        "Du har {{count}} ikke-gemte filer. Vil du gemme dine ændringer?",
    },
    home: {
  ...
  no: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Automatisk lagring mislyktes — ulagrede endringer er fortsatt i minnet",
      savedNewerEdits:
        "Lagret — forblir i redigeringsmodus fordi du har nyere endringer",
    },
    modal: {
      confirmExit: "Bekreft avslutning",
      areYouSureYouWantToExit:
        "Er du sikker på at du vil avslutte? Alle ulagrede faner og lokal historikk vil gå tapt.",
      unsavedChanges: "Ulagrede endringer",
      youHaveUnsavedChanges:
        'Du har ulagrede endringer i "{title}". Vil du lagre dem før lukking?',
      youHaveUnsavedChangesBeforeReturning:
        "Du har ulagrede endringer. Vil du lagre dem før du går tilbake til forhåndsvisningsmodus?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Du har ulagrede endringer. Vil du lagre dem før du lukker delt visning?",
      youHaveUnsavedFiles:
        "Du har {{count}} ulagrede filer. Vil du lagre endringene dine?",
    },
    home: {
      welcomeToDraftly: "Velkommen til Draftly",
  ...
  id: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Penyimpanan otomatis gagal — perubahan yang belum disimpan masih ada di memori",
      savedNewerEdits:
        "Tersimpan — tetap di mode edit karena ada perubahan yang lebih baru",
    },
    modal: {
      confirmExit: "Konfirmasi Keluar",
      areYouSureYouWantToExit:
        "Anda yakin ingin keluar? Semua tab yang belum disimpan dan riwayat lokal akan hilang.",
      unsavedChanges: "Perubahan Belum Disimpan",
      youHaveUnsavedChanges:
        'Anda memiliki perubahan yang belum disimpan di "{title}". Apakah Anda ingin menyimpannya sebelum menutup?',
      youHaveUnsavedChangesBeforeReturning:
        "Anda memiliki perubahan yang belum disimpan. Apakah Anda ingin menyimpannya sebelum kembali ke mode pratinjau?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Anda memiliki perubahan yang belum disimpan. Apakah Anda ingin menyimpannya sebelum menutup tampilan terpisah?",
      youHaveUnsavedFiles:
        "Anda memiliki {{count}} berkas yang belum disimpan. Apakah Anda ingin menyimpan perubahan Anda?",
    },
    home: {
    ...
    uninstaller: {
      ...
      removeApplication:
        "Tindakan ini akan menghapus aplikasi dan semua pintasannya.",
      cancel: "Batal",
  ...
  tr: {
    ...
    toast: {
      ...
      autoSaveFailed:
        "Otomatik kaydetme başarısız — kaydedilmemiş değişiklikler hâlâ bellekte",
      savedNewerEdits:
        "Kaydedildi — daha yeni düzenlemeleriniz olduğu için düzenleme modunda kalınıyor",
    },
    modal: {
      confirmExit: "Çıkışı Onayla",
      areYouSureYouWantToExit:
        "Çıkmak istediğinizden emin misiniz? Tüm kaydedilmemiş sekmeler ve yerel geçmiş kaybolacak.",
      unsavedChanges: "Kaydedilmemiş Değişiklikler",
      youHaveUnsavedChanges:
        '"{title}" içinde kaydedilmemiş değişiklikleriniz var. Kapatmadan önce kaydetmek istiyor musunuz?',
      youHaveUnsavedChangesBeforeReturning:
        "Kaydedilmemiş değişiklikleriniz var. Önizleme moduna dönmeden önce kaydetmek istiyor musunuz?",
      youHaveUnsavedChangesBeforeClosingSplitView:
        "Kaydedilmemiş değişiklikleriniz var. Bölünmüş görünümü kapatmadan önce kaydetmek istiyor musunuz?",
      youHaveUnsavedFiles:
        "{{count}} kaydedilmemiş dosyanız var. Değişikliklerinizi kaydetmek istiyor musunuz?",
    },
    home: {
