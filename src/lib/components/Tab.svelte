<script lang="ts">
  ...
  function handleContextMenu(e: MouseEvent) {
    ...
    tabContextMenu = {
      ...
      items: [
        ...
        { separator: true },
        {
          label: t("menu.closeFile", currentLang),
          shortcut: "Ctrl+W",
          onClick: () => emit("menu-tab-close", tab.id),
        },
        {
          label: t("menu.closeOtherTabs", currentLang),
          onClick: () => emit("menu-tab-close-others", tab.id),
        },
        {
          label: t("menu.closeTabsToRight", currentLang),
          onClick: () => emit("menu-tab-close-right", tab.id),
        },
      ],
    };
  }
  ...
  let fileIcon = $derived(getFileIcon(tab.path || tab.title));
</script>
...
>
  ...
  >
    {#if !isHomeTab && fileIcon}
      <img class="tab-file-icon" src={fileIcon} alt="" aria-hidden="true" />
    {/if}
