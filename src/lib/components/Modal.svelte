  ...
  >
    ...
    >
      ...
      <div class="modal-footer">
        <button class="modal-btn secondary" onclick={oncancel}
          >{t("settings.cancel", settings.language)}</button
        >
        <div class="footer-spacer"></div>
        <button class="modal-btn secondary" onclick={onconfirm}>
          {kind === "warning"
            ? t("settings.discard", settings.language)
            : t("settings.save", settings.language)}
        </button>
        {#if showSave}
          <button class="modal-btn primary" onclick={onsave}
            >{t("settings.save", settings.language)}</button
          >
        {/if}
      </div>
    </div>
