	...
	<div class="window-controls-left" data-tauri-drag-region>
		...
		<div class="home-menu-container" role="presentation">
			...
			onmouseenter={(e) => {
				...
				<svg class="window-icon" width="15" height="15" viewBox="0 0 288 283" fill="none" aria-hidden="true">
					<path d="M229.174 211.242L0 27.4131V207.715C0 249.294 33.7061 283 75.2846 283H287.565V75.2846C287.565 33.7061 253.858 0 212.28 0H24.6719L92.6566 47.5698H194.042C213.445 47.5698 229.174 63.2993 229.174 82.7026V211.242Z" fill="url(#draftly-title-icon-gradient)"/>
					<defs>
						<linearGradient id="draftly-title-icon-gradient" x1="288" y1="0" x2="-197" y2="562" gradientUnits="userSpaceOnUse">
			...
			{#if homeMenuOpen}
				<div class="home-dropdown-menu" transition:fly={{ y: 5, duration: 150 }} onpointerdown={(e) => e.stopPropagation()}>
					<button
	...
	{#snippet actionItems(ids: string[])}
		...
		{#if isCollapsed}
			{#if visibleActionIds.length > 0}
				{@render kebabButton()}
				{#if kebabMenuOpen}
					<div class="title-actions show-dropdown" data-tauri-drag-region transition:fly={{ y: 5, duration: 150 }} onpointerdown={(e) => e.stopPropagation()}>
