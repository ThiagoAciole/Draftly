...
<div class="zoom-overlay" transition:fade={{ duration: 150 }} onpointerdown={onclose} role="presentation" bind:this={overlayEl}>
	<button class="close-btn" onpointerdown={(e) => e.stopPropagation()} onclick={onclose} aria-label={t('common.close', settings.language)}>
